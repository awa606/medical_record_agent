...
| 版本 | 阶段 | 说明 |
| --- | --- | --- |
| v0.1 | POC | 文本版 Agent 骨架，验证问诊文本到病历草稿的基本流程。 |
| v0.2 | MVP | Mock ASR 与三入口流程，支持文本、音频转写、音频生成病历。 |
| v0.3 | Evaluation | FunASR 可选引擎、ASR 评测和角色策略。 |
| v0.3.1 | Rule tuning | fever 场景字段抽取规则补充。 |
| v0.4 | Workflow | 医生端、调试台、入口页拆分，增强任务状态和审计链路。 |
| v0.4.5 | Documentation | README、目录说明和 GitHub 上传边界整理。 |
| v1.0 | Academic engineering | Issue、PR、日志、调试和版本管理规范化。 |

完整版本说明见 [`docs/version_log.md`](docs/version_log.md)。
