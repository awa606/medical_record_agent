...
本仓库同时维护工程管理结构：GitHub Issues、PR 模板、每日工作日志、调试报告和版本演进记录。当前版本已覆盖 ASR 会话级 SSE 文件流、医生/患者角色校正、医学知识库规则解释和本地 ASR 多引擎评测，FunASR、SenseVoice 与 Whisper 已完成本机样本实测，不改变核心 ASR/LLM 算法逻辑。
