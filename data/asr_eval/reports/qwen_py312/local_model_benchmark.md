...
| torch | 可用 | 2.12.1+cpu |
| FunASR | 不可用 | 未检测到版本 |
| Qwen-ASR | 不可用 | Could not read model from <PROJECT_ROOT>\.venv-qwen-asr\Lib\site-packages\nagisa/data/nagisa_v001.model |
| Whisper | 不可用 | 未检测到版本 |
...
| --- | --- | --- | ---: | ---: | --- |
| qwen3 | skipped | - | 0 | 0 | Could not read model from <PROJECT_ROOT>\.venv-qwen-asr\Lib\site-packages\nagisa/data/nagisa_v001.model |

## ASR 评测结果

| 报告 | 引擎 | 成功样本 | Smoke 样本 | 失败样本 | 平均 CER | 平均关键词召回 | 平均耗时秒 | 平均 RTF | 状态 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 无 | 待评测 | 0 | 0 | 0 | - | - | - | - | no_csv_reports |
...
- 评测状态：framework_ready_engines_skipped。
