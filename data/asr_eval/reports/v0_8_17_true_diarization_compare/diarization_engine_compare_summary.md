...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| funasr_campp | `failed` | 0 | - | - | - | - | - | - | 0.0001 | 40.7 | engine returned no diarization turns for a non-empty RTTM reference |
| pyannote_community_1 | `skipped` | - | - | - | - | - | - | - | - | - | pyannote.audio is not installed |
