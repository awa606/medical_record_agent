...
访问日期：2026-09-15（Asia/Shanghai）。报价页只作为当次采样；未同时披露型号、税费、库存/交期和运费的条目不得称为有效落地报价。
...
| [iCEasy Jetson Orin Nano Super](https://www.iceasy.com/product/JETSON_ORIN_NANO_SUPER_DEVELOPER_KIT) | Distributor | 3199元、订货库存与12–14周交期 | 运费及制造商料号未同时披露，只作参考 |
...
| [Waveshare CASE-A Product](https://www.waveshare.com/product/jetson-orin-case-a.htm) | Vendor product | $11.99、顶部风扇孔、三侧通风和接口开口 | 国际运费与税费未闭合 |
| [Waveshare CASE-A/B docs](https://docs.waveshare.com/JETSON-ORIN-CASE-B) | Vendor docs | CASE-A兼容官方开发套件的声明 | J11 SSD实物净空未闭合 |
| [Waveshare Assembly Guide](https://docs.waveshare.com/JETSON-ORIN-CASE-B/Assembly-Guide) | Vendor docs | M2.5直接安装、面板、天线、按钮与可拆装流程 | 不证明具体SSD厚度/热垫净空 |
