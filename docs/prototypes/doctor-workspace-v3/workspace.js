...
(() => {
  ...
  function renderSummary() {
    ...
    $("panel-content").innerHTML = [
      ...
      ? '<p class="ml-panel-caption">待病历草稿生成后，显示需要核对和补充的项目。</p>'
      : `<section class="ml-summary-card"><h3>过敏史</h3><p>患者否认花生及药物过敏。</p><button data-source="allergy_history">查看原文</button></section><section class="ml-summary-card"><h3>待补充</h3><ul><li>既往病史</li><li>查体结果</li><li>已用药情况</li></ul></section><section class="ml-summary-card"><h3>参考资料</h3><p class="ml-panel-caption">指南与规范供医生核对。</p><button data-panel="knowledge">查询依据</button></section>`;
  }
  ...
  $("record-fields").addEventListener("input", (event) => {
    ...
    $("action-hint").textContent = "有未保存修改";
  });
