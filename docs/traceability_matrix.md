...
| role separation (doctor/patient) | [#3](https://github.com/awa606/medical_record_agent/issues/3) | `versions/v0.3_role_separation/` | `app/services/asr/role_strategy.py`、`app/schemas/asr.py` | `tests/test_asr_role_strategy.py` | `docs/asr_v0_3.md`、`versions/v0.3_role_separation/README.md` |
