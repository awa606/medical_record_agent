...
| `v0.5.4` | 已具备 | 中文优先 ASR 评测口径、普通医院 Windows PC 配置基线、Python 3.12 Qwen-ASR 隔离环境复测 |
| `v0.5.5` | 已具备 | 通过 ASCII 运行区解除 Qwen-ASR/nagisa 中文路径阻塞，完成公开 smoke 和课程中文短样本实测 |
| `v0.5.6` | 已具备 | 为 FunASR、SenseVoice、Qwen3 统一补充中文医患样本 CER、关键词召回、RTF、CPU 和 RSS 指标 |
| `v0.5.7` | 已具备 | Qwen3 分样本补测完成三条中文医患样本，形成长音频稳定性记录；v0.6 默认建议 SenseVoice/FunASR |
