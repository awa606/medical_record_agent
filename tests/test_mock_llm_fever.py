...
[医生] 这次主要哪里不舒服？[患者] 发热3天了，3天前淋雨受凉后开始发热。[医生] 最高体温多少？有没有咳嗽咳痰？
[患者] 最高体温40℃，体温多在39到40℃，伴咳嗽、咳痰，曾有铁锈色痰。[医生] 之前在哪里看过，用过什么药？[患者] 当地卫生院考虑感冒，服用布洛芬后可以退热，但还是反复发热。[医生] 食欲睡眠和大小便怎么样？既往有什么病史和过敏史？
...
class MockLLMFeverTests(unittest.TestCase):
    def test_extract_fields_supports_fever_case(self):
        ...
        self.assertIn("最高体温约40℃", fields.present_illness.value)
